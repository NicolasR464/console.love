        ...
        <div className="flex">
          <div className="carousel w-full h-80 rounded-2xl">
            <div id="slide1" className="carousel-item relative w-full">
              <img
                src="https://i0.wp.com/studio-baindelumiere.fr/wp-content/uploads/2022/04/photo-site-de-rencontre-20.webp?resize=612%2C920&ssl=1"
            ...
            <div id="slide2" className="carousel-item relative w-full">
              <img
                src="https://images.squarespace-cdn.com/content/v1/5707c9364c2f85d0ea64d6ee/1561997865068-MUSRAJF85S5RMZ2XV8S2/Shooting+photo+site+de+rencontres"
                className="h-full m-auto"
              />
              <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
            ...
            <div id="slide3" className="carousel-item relative w-full">
              <img
                src="https://images.squarespace-cdn.com/content/v1/5707c9364c2f85d0ea64d6ee/1562054294775-22LY0L2F0933P3MGTN4N/Shooting+photo+site+de+rencontres?format=1000w"
                className="h-full m-auto"
              />
              <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                <a href="#slide2" className="btn btn-circle">
            ...
            <div id="slide4" className="carousel-item relative w-full">
              <img
                src="https://images.squarespace-cdn.com/content/v1/5707c9364c2f85d0ea64d6ee/1561997746158-LZBXMGI1QGHKNNS84XLW/Shooting+photo+site+de+rencontres"
                className="h-full m-auto"
              />
              <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                <a href="#slide3" className="btn btn-circle">
